      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              <Magnetic>
                <Link download="Salman Shah Full-Stack Web Developer Resume.pdf" href={'/Salman Shah Full-Stack Web Developer Resume.pdf'}><button className="flex items-center gap-3 px-8 py-4 bg-white text-black font-bold rounded-xl hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-lg group">
                  Download Resume
